...
python scripts\performance_comparison.py --queries data\eval\qa_pairs.json --output results\initial_comparison_results.json --llm-models "gemma2-9b-it,llama3-8b-8192" --embedding-models "all-mpnet-base-v2,multi-qa-mpnet-base-dot-v1"

REM Generate initial report
echo Step 3: Generating initial report...
python scripts\generate_report.py --results results\initial_comparison_results.json --output results\initial_performance_report.html
